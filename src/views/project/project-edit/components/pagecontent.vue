    ...
    <div class="page-con">
        <grid-layout
            ...
            <grid-item v-for="item in layout"
                    ...
                    :i="item.i"
                    :key="item.i">
                <el-card shadow="never" @click.native="chooseItem(item)" @drop.native="dropHandle($event, item)" @dragover.native="allowDrop($event)"
                    class="pro-card" :class="{sel: curSelItem.i==item.i}" :body-style="{padding:'5px'}">
                    <div class="btns">
...
export default {
  ...
  data() {
    return {
      layout: [
        { x: 0, y: 0, w: 12, h: 10, i: "0", template: '', data: null },
        { x: 2, y: 0, w: 2, h: 10, i: "1", template: '', data: null },
        { x: 4, y: 0, w: 2, h: 10, i: "2", template: '', data: null },
        { x: 6, y: 0, w: 2, h: 10, i: "3", template: '', data: null },
        { x: 8, y: 0, w: 2, h: 10, i: "4", template: '', data: null },
        { x: 10, y: 0, w: 2, h: 10, i: "5", template: '', data: null }
      ],
      curSelItem: {}
    };
  },
  methods: {
    ...
    addBlock() {
      ...
      this.layout.push({ x: x, y: x, w: 2, h: 10, i: id, template: '', data: null })
    },
    allowDrop(event) {
